...
int main()
{
    ...
    */
    ...
    /*
    vector<vector<int>> vect
    We can divide this declartion to two parts, which will
    help us to understand the below concepts.
     
    1. vect is a 2D vector consiting multiple elements of type vector<int>.
    2. vector<int> is a 1D vector consiting of multiple int data.
     
    So we can use iterator provided by STL instead of
    i,j varaible used in for loop. It can reduce the error which can
